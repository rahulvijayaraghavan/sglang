...
class DeepSeekV4TokenToKVPool(KVCache):
    ...
    def __init__(
        ...
        # per-request states used by the SGLANG_OPT_USE_OLD_COMPRESSOR=1
        # fallback (e.g. on Intel XPU where the fused CUDA compress JIT
    ...
    def _init_compress_states(self, enable_memory_saver: bool):
        ...
        old-compressor fallback (SGLANG_OPT_USE_OLD_COMPRESSOR=1).
